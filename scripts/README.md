# 🏢 Scripts สำหรับจัดการห้างสรรพสินค้า
...
```
- สร้างไฟล์ `mall-template.json` พร้อมตัวอย่างข้อมูล
- แก้ไขข้อมูลในไฟล์แล้วรันคำสั่งต่อไป

### **2. เพิ่มห้างจากไฟล์ JSON**
```bash
node scripts/add-mall-complete.js --file mall-template.json
```
- เพิ่มห้างจากไฟล์ JSON ที่แก้ไขแล้ว
- รองรับทั้งห้างเดียวและหลายห้าง

### **3. เพิ่มห้างแบบ Interactive**
```bash
...
### **4. ดูความช่วยเหลือ**
```bash
node scripts/add-mall-complete.js --help
```
